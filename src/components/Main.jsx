...
export default function Main() {
  return (
    <>
        <div className="flex lg:flex-row flex-col lg:justify-center items-center lg:p-8 p-4 font-sans bg-[#F1FAFC] min-h-screen">
          <div className="lg:w-[23rem] bg-white w-full border-2 lg:border-r-0 border-gray-200 p-5 rounded-2xl lg:rounded-r-none">
            ...
            <div className="mt-auto w-full">
              ...
              <div className="text-xs mt-3 text-slate-600 line-height-2">Literally you probably haven't heard of them jean shorts.</div>
            </div>
          </div>
